                ...
                >
                    ...
                    <div className="flex-1 overflow-y-auto overscroll-contain min-h-0">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        {rooms.length > 1 && (
                                            <button
                                                ...
                                                className="text-[#0057ff] text-[11px] font-black hover:underline px-2 py-0.5 rounded-md hover:bg-blue-50 transition-colors"
                                            >
                                                {t("removeRoom")}
                                            </button>
                                        )}
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-3">
                                                <Button
                                                    ...
                                                    variant="outline"
                                                    size="icon"
                                                    className="h-8 w-8 rounded-full border-slate-200 bg-white hover:border-[#0057ff] hover:text-[#0057ff] hover:bg-blue-50 transition-all shadow-sm active:scale-95"
                                                    onClick={() => updateRoom(index, Math.max(1, room.adults - 1), room.children)}
                                                    disabled={room.adults <= 1}
                                                >
                                                    <Minus className="h-3.5 w-3.5" />
                                                </Button>
                                                <span className="w-5 text-center font-black text-sm text-[#051c34]">{room.adults}</span>
                                                <Button
                                                    type="button"
                                                    variant="outline"
                                                    size="icon"
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="w-5 text-center font-black text-sm text-[#051c34]">{room.children}</span>
                                                <Button
                                                    type="button"
                                                    variant="outline"
                                                    size="icon"
                        ...
                        {rooms.length < 8 && (
                            <div className="px-5 pb-4 pt-2">
                                ...
                                >
                                    <div className="w-5 h-5 rounded-full border-2 border-current flex items-center justify-center group-hover:bg-blue-50 transition-colors">
                    ...
                    <div className="px-5 py-3.5 border-t border-slate-100 bg-white flex items-center justify-between gap-3 shrink-0">
                        ...
                        <Button
                            ...
                            className="rounded-full bg-[#051c34] hover:bg-[#0a2f58] text-white font-black px-6 py-2 text-sm tracking-tight shadow-lg transition-all hover:scale-105 active:scale-95 shrink-0"
                        >
                            {t("done")}
                        </Button>
                    </div>
